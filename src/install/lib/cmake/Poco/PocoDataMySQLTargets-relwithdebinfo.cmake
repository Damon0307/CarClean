...
set_target_properties(Poco::DataMySQL PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libPocoDataMySQL.so.101"
  IMPORTED_SONAME_RELWITHDEBINFO "libPocoDataMySQL.so.101"
  )

list(APPEND _IMPORT_CHECK_TARGETS Poco::DataMySQL )
list(APPEND _IMPORT_CHECK_FILES_FOR_Poco::DataMySQL "${_IMPORT_PREFIX}/lib/libPocoDataMySQL.so.101" )
